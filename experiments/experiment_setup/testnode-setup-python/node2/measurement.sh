...
pos_sync
sleep 1
tcprewrite --infile="$pcap" --outfile=ba-doering/prototype/code/pcaps/pcap_experiment.pcap --portmap="$portremap" --enet-dmac="$ethnode1" --enet-smac="$ethnode2"
tcpreplay --intf1="$ifnode2" ba-doering/prototype/code/pcaps/pcap_experiment.pcap &
