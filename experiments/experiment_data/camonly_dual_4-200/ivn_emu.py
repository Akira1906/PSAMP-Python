...
class CamOnly(IVNEmu):
    def gen_flows(self):
        ...
        q.append_flow(f3.pkts)
        q.append_flow(f4.pkts)
        q.append_flow(f5.pkts)
        q.append_flow(f6.pkts)
